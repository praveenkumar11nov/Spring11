...
public class ApiBasicAuthentication {
	...
	@ResponseBody
	@RequestMapping(value="/getDataFromApplicationTestingAOP",method={RequestMethod.POST},produces="application/json")
	public String getdataFromAppTestingAOP(HttpServletRequest request) throws JSONException {
